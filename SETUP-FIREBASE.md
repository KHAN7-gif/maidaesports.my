...
## 2) Cara ia berfungsi
- Buka **admin.html** → log masuk (`admin7` / `maida2026`) → edit → **Simpan**
...
## 5) Log masuk admin
Nama pengguna: **admin7** · Kata laluan: **maida2026**

Untuk menukar, buka `admin.html` dan cari baris:
```js
const USERNAME = "admin7";
const PASSWORD = "maida2026";
```
(Ini pagar ringkas di pelayar — untuk keselamatan penuh, guna Firebase Auth.)
